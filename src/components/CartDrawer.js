          ...
          <div className="cart-foot">
            <a
              ...
              href={(() => {
                ...
                const message = `Hello Jaya & Preeti Lifestyle,

I am interested in the following products:

${items}

Please share the latest price, availability, and delivery details.

Thank you.`;

                return `https://wa.me/${SELLER.whatsapp}?text=${encodeURIComponent(
                  message
                )}`;
              })()}
              target="_blank"
